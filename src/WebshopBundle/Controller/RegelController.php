...
class RegelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('regel/index.html.twig', array(
            'regels' => $regels,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('regel/new.html.twig', array(
            'regel' => $regel,
    ...
    public function showAction(Regel $regel)
    {
        ...
        return $this->render('regel/show.html.twig', array(
            'regel' => $regel,
    ...
    public function editAction(Request $request, Regel $regel)
    {
        ...
        return $this->render('regel/edit.html.twig', array(
            'regel' => $regel,
